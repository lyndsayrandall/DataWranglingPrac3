...
setwd("D:/D_Documents/RMIT/Data Wrangling/Assignment_3")
csvFileNames <- list.files("D:/D_Documents/RMIT/Data Wrangling/Assignment_3/Data",pattern = "*.csv", full.names = TRUE)
csvFileNames


vicRoadsDFList <- sapply(csvFileNames, function(i) read_csv(i, show_col_types = FALSE))

testDFNames <- read.csv("D:/D_Documents/RMIT/Data Wrangling/Assignment_3/Data/ACCIDENT.csv")
testDFNames1 <- read_csv("D:/D_Documents/RMIT/Data Wrangling/Assignment_3/Data/ACCIDENT.csv")
#Return key to manageable file name
names(vicRoadsDFList) <- c(gsub("D:/D_Documents/RMIT/Data Wrangling/Assignment_3/Data/","", names(vicRoadsDFList)))
str(vicRoadsDFList[1])

councilsVic_sf <- read_sf("D:/D_Documents/RMIT/Data Wrangling/Assignment_3/Councils/georef-australia-local-government-area.geojson") %>% 
